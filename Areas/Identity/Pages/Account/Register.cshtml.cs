...
namespace MVCBasics.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        [BindProperty] public IEnumerable<IdentityRole> Roles => _roleManager.Roles.ToList();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (currentUser != null)
                    {
                        var roleResult = await _userManager.AddToRoleAsync(currentUser, Input.Role);
                        if (!roleResult.Succeeded)
                        {
                            _logger.LogInformation("Failed to assign role to user");
                        }
                    }
