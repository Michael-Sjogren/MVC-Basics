...
function PeopleList(props) {
    ...
    const createPerson = async (person) => {
        // validate person
        await axios.post("/React/People/Create", person);
        await getPeople();
    }
    // updates everytime you click on a table row
    ...
    return (
        <>
            <div className="d-flex flex-wrap">
                <CreatePerson onCreatePerson={createPerson} cities={cities} languages={languages}/>
                <PersonDetails person={selectedPerson} onDeletePerson={deletePerson}/>
            </div>
            <div className="mt-2">
